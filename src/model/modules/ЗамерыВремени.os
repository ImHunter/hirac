...
Процедура СохранитьПараметрыЗамера(ПараметрыЗамера)
	...
	ЗаписатьВНовыйФайлЛога = ФайлЛога = Неопределено;
	Если ЗаписатьВНовыйФайлЛога Тогда
		ФайлЛога = Новый ЗаписьТекста();
	КонецЕсли;
	Попытка
		ФайлЛога.Открыть(Настройки.ФайлЛогаЗамеровВремени(), , , Не ЗаписатьВНовыйФайлЛога);
	Исключение
